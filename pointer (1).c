 ...
 *
 * Name(s):Catalina Martinez, Abdulmajid Ali
 * NetID(s): 2065453,2141707 
 *
...
/*wget https://courses.cs.washington.edu/courses/cse351/22au/labs/lab1a.tar.gzwget https://courses.cs.washington.edu/courses/cse351/22au/labs/lab1a.tar.gzwget https://courses.cs.washington.edu/courses/cse351/22au/labs/lab1a.tar.gz
...
int change_value(){
  ...
  int_ptr1 = int_ptr1 + 5;
  *int_ptr1 = 0;
  *int_ptr1 = *int_ptr1 + 255;
  *int_ptr1= *int_ptr1 + 96;
   
 return *(int_array + 5); // int_array[5];
}
...
int within_same_block(int* ptr1, int* ptr2) {
 ...
 //  if(*ptr1 ==*ptr2) {
 //	  return 1; }
 //	  subtact should be 0x00,,if difference
 long x, y;
 x = (long)ptr1;
 y = (long)ptr2;
x = x>> 6;
...
return (x==y);
	...
	long dif1, dif2;
	x = int_array + (size);
	 dif1 = (long) ptr - (long) x;
	dif1 =  dif1 >> 63;

	 dif2 = (long) ptr - (long) int_array;
	dif2 = dif2 >> 63;

// int dif 1 = ptr - star, dif 2 = ptr - end, compare signs
